...
func (c *demoClient) Ping(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/ozon.newscratch.Demo/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDemoServer) Ping(context.Context, *emptypb.Empty) (*Response, error) {
...
var Demo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ozon.newscratch.Demo",
	...
	Metadata: "gitlab.ozon.ru/newscratch/api/api.proto",
}
